                    ...
                    <div class="row">
                        <div class="col-lg-10">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control <?= session()->has('errors') && array_key_exists('nama_lengkap', session('errors')) ? 'is-invalid' : null ?>" id="namaLengkap" placeholder="Masukan Nama Lengkap" autocomplete="off" name="nama_lengkap">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control <?= session()->has('errors') && array_key_exists('username', session('errors')) ? 'is-invalid' : null ?>" id="username" placeholder="Masukan Username" autocomplete="off" name="username">
                            ...
                            <div class="form-group">
                                ...
                                <input type="password" class="form-control <?= session()->has('errors') && array_key_exists('password', session('errors')) ? 'is-invalid' : null ?>" id="password" placeholder="Masukan Password" autocomplete="off" name="password">
